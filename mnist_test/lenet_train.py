...
if __name__ == '__main__':
    ...
    if config.TRIPLET_TRAINING:
        solver_prototxt = '/project/focus/abby/tripletloss/mnist_test/lenet_tripletloss_solver.prototxt'
    else:
        solver_prototxt = '/project/focus/abby/tripletloss/mnist_test/lenet_solver.prototxt'
