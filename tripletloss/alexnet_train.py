...
if __name__ == '__main__':
    """Train network."""
    solver_prototxt = '/project/focus/abby/tripletloss/alexnet_solver.prototxt'
    output_dir = '/project/focus/abby/tripletloss/models/outputs/alexnet/'
    pretrained_model = '/project/focus/abby/hotelnet/models/places-alexnet/places205CNN_iter_300000.caffemodel'
    #pretrained_model = None
